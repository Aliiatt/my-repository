...
# When the user comes directly "/calc" path, dislay the message "Since this is a GET request, LCM has not been calculated"
...
def calculate():
    if request.method == "POST":
       ...
       return render_template('result.html', lcm=answer, result1=first_num, result2=second_num, developer_name = 'Aliia')
